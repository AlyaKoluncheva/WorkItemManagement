...
public abstract class AssignableBase extends WorkItemBase implements Assignable {
    ...
    public AssignableBase(String boardName, String title, String description, Priority priority, Status status, String assignee) {
    ...
    public AssignableBase(String boardName, String title, String description, Priority priority, Status status) {
        super(boardName, title, description, status);
